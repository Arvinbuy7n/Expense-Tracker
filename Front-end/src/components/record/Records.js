...
export const Records = () => {
    ...
    return (
        <div className="w-full h-full flex flex-col max-w-[1800px] m-auto relative">
            ...
            <div className="flex w-full h-full px-36 py-7 gap-5 bg-slate-100">
                <div className="w-1/4 border-2 bg-white rounded-2xl p-5 gap-[24px] flex flex-col">
                    <div className="flex flex-col gap-[24px]">
                        ...
                        <button className="bg-[#0166FF] text-white w-full rounded-2xl py-1 text-[18px]" onClick={getData}>+ Add</button>
                    </div>
                    <input
                        type="text"
                        placeholder="  Search"
            ...
            <div className="absolute flex justify-center items-center mt-[350px] w-full">
                {
