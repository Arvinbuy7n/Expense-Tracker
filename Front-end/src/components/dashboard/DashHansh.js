    ...
    return (
        <div className=" flex gap-8 px-36 w-full h-[250px]">
            <div className="w-1/3 relative">
                <img src="noise.png" className="bg-blue-600 w-full h-[250px] rounded-2xl"></img>
                ...
                <img src="logo.png" className="absolute bottom-0 right-0 py-10 px-10"></img>
            </div>
            <div className="w-1/3 bg-white rounded-xl">
                ...
                <div className="p-6 flex flex-col gap-1">
                    ...
                    <p className="text-[18px] text-[#64748B] font-normal">Your Income Amount</p>
