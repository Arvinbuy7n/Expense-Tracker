    ...
    return (
        <div className="w-[50%] flex flex-col gap-6">
            <div className="bg-[#F3F4F6] rounded-3xl flex justify-between">
                ...
                }} className="px-16 py-2 text-black rounded-3xl" style={{ background: props.type === "Expense" ? "#0166FF" : "transparent" }}>Expense</button>
                <button onClick={() => {
                    props.setType("Income")
                }} className="px-16 py-2 text-black rounded-3xl" style={{ background: props.type === "Income" ? "red" : "transparent" }} >Income</button>
            </div>
            <input
                type="text"
                placeholder="  ₮ 000.00"
